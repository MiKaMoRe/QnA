...
ActiveRecord::Schema.define(version: 2021_09_26_150526) do
  ...
  create_table "rewards", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["question_id"], name: "index_rewards_on_question_id", unique: true
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["author_id", "voteable_id"], name: "index_votes_on_author_id_and_voteable_id", unique: true
